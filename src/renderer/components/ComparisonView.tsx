...
export default function ComparisonView() {
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="text-center animate-fade-in">
          <div className="w-16 h-16 mx-auto mb-4 rounded-md bg-surface-900 border border-surface-600 flex items-center justify-center">
            <svg className="w-8 h-8 text-surface-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
              <rect x="3" y="3" width="18" height="18" rx="2" />
              <path d="M3 9h18M9 21V9" />
            </svg>
          </div>
          <p className="text-surface-300 font-body mb-4">No set selected</p>
          <button
  ...
  return (
    <div className="h-full flex flex-col animate-fade-in">
      ...
      {/* File List */}
      <div className="h-72 border-t border-surface-600 overflow-auto bg-surface-900">
